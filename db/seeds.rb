...
a8 = Album.create(cover: "https://upload.wikimedia.org/wikipedia/en/2/23/Rhcp9.jpg", title: "By The Way", artist: "Red Hot Chili Peppers")

Track.create(name: "By the Way", minutes:	"3:37", album_id: a8.id)
Track.create(name: "Universally Speaking", minutes:	"4:19", album_id: a8.id)
Track.create(name: "This Is the Place", minutes:	"4:17", album_id: a8.id)
Track.create(name: "Dosed", minutes:	"5:12", album_id: a8.id)
Track.create(name: "Don't Forget Me", minutes:	"4:37", album_id: a8.id)
Track.create(name: "The Zephyr Song", minutes:	"3:52", album_id: a8.id)
Track.create(name: "Can't Stop", minutes:	"4:29", album_id: a8.id)
Track.create(name: "I Could Die for You", minutes:	"3:13", album_id: a8.id)
Track.create(name: "Midnight", minutes:	"4:55", album_id: a8.id)
Track.create(name: "Throw Away Your Television", minutes:	"3:44", album_id: a8.id)
Track.create(name: "Cabron", minutes:	"3:38", album_id: a8.id)
Track.create(name: "Tear", minutes:	"5:17", album_id: a8.id)
Track.create(name: "On Mercury", minutes:	"3:28", album_id: a8.id)
Track.create(name: "Minor Thing", minutes:	"3:37", album_id: a8.id)
Track.create(name: "Warm Tape", minutes:	"4:16", album_id: a8.id)
Track.create(name: "Venice Queen", minutes:	"6:07", album_id: a8.id)

a9 = Album.create(cover: "https://upload.wikimedia.org/wikipedia/en/3/3b/Sky_Blue_Sky_%28Front_Cover%29.png", title: "Sky Blue Sky", artist: "Wilco")

Track.create(name: "Either Way", minutes: "3:05", album_id: a9.id)
Track.create(name: "You Are My Face", minutes: "4:38", album_id: a9.id)
Track.create(name: "Impossible Germany", minutes: "5:57", album_id: a9.id)
Track.create(name: "Sky Blue Sky", minutes: "3:23", album_id: a9.id)
Track.create(name: "Side with the Seeds", minutes: "4:15", album_id: a9.id)
Track.create(name: "Shake It Off", minutes: "5:40", album_id: a9.id)
Track.create(name: "Please Be Patient with Me", minutes: "3:17", album_id: a9.id)
Track.create(name: "Hate It Here", minutes: "4:31", album_id: a9.id)
Track.create(name: "Leave Me (Like You Found Me)"	, minutes: "4:09", album_id: a9.id)
Track.create(name: "Walken", minutes: "4:26", album_id: a9.id)
Track.create(name: "What Light", minutes: "3:35", album_id: a9.id)
Track.create(name: "On and On and On", minutes: "4:00", album_id: a9.id)
